...
class team_member(models.Model):
    ...
    photo = models.ImageField(null=True, blank=True, upload_to='images/', default='/images/default_photo.jpg')
    role = models.CharField(max_length=100, null=True, blank=True, default='зритель')
